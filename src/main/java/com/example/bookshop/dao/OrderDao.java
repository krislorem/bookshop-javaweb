...
public class OrderDao {
    ...
    public int getLastInsertId(Connection con) throws SQLException {
        ...
        BigInteger bi = r.query(con, sql, new ScalarHandler<>());
    ...
    public List<Order> selectAll(int userid) throws Exception {
    ...
    public List<OrderItem> selectAllItem(int orderid) throws Exception {
        QueryRunner r = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public int getOrderCount(int status) throws Exception {
        QueryRunner r = new QueryRunner(DataSourceUtils.getDataSource());
        String sql;
        if (status == 0) {
    ...
    public List<Order> selectOrderList(int status, int pageNumber, int pageSize) throws Exception {
        QueryRunner r = new QueryRunner(DataSourceUtils.getDataSource());
        if (status == 0) {
