...
<div class="container-fluid">
	...
	<br><br>
	<form id="goodsedit" class="form-horizontal" action="${pageContext.request.contextPath }/admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-6"><img src="${pageContext.request.contextPath }${g.cover }" width="100" height="100" alt=""/>
				<input type="file" name="cover"  id="cover">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="image1" class="col-sm-1 control-label">详情图片1</label>
			<div class="col-sm-6"><img src="${pageContext.request.contextPath }${g.image1 }" width="100" height="100" alt=""/>
				<input type="file" name="image1"  id="image1">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="image2" class="col-sm-1 control-label">详情图片2</label>
			<div class="col-sm-6"><img src="${pageContext.request.contextPath }${g.image2 }" width="100" height="100" alt=""/>
