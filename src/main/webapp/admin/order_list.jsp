...
<div class="container-fluid">
    ...
    <ul role="tablist" class="nav nav-tabs">
        <li
                <c:if test="${status==0 }">class="active"</c:if> role="presentation"><a
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger"
                       href="${pageContext.request.contextPath }/admin/order_delete?id=${order.id }&pageNumber=${p.pageNumber}&status=${status}">删除</a>
                </td>
            </tr>
        </c:forEach>
